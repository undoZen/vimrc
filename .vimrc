...
let wiki1.netest_syntaxes = {'ruby':'ruby','py': 'python', 'js': 'javascript', 'html': 'html', 'css': 'css', 'bash': 'sh'}
let wiki2 = {}
let wiki2.path = '/home/yuest/Dropbox/vimwiki/note'
let wiki2.netest_syntaxes = {'ruby':'ruby','py': 'python', 'js': 'javascript', 'html': 'html', 'css': 'css', 'bash': 'sh'}
